...
// Imported from https://github.com/Gabb-c/pokenode-ts/blob/master/src/models/Pokemon/pokemon.ts
// Should import class next time. Since this is specific use case and prevent overfetch
/**
 * ## Pokemon
